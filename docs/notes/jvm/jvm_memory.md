...
![image-20200928135810574](images/jvm_memory.assets/image-20200928135810574.png)

### 1.2堆内存图解：

![image-20200928135830369](images/jvm_memory.assets/image-20200928135830369.png)
...
![image-20200928140013168](images/jvm_memory.assets/image-20200928140013168.png)

### 2.3加载顺序：

![image-20200928140023681](images/jvm_memory.assets/image-20200928140023681.png)
...
```
![image-20200928140119052](images/jvm_memory.assets/image-20200928140119052.png)

编译后的运行结果：

![image-20200928140125444](images/jvm_memory.assets/image-20200928140125444.png)
...
![image-20200928140146957](images/jvm_memory.assets/image-20200928140146957.png)
...
![image-20200928140632269](images/jvm_memory.assets/image-20200928140632269.png)

### 3.4数组中的异常：

#### 3.4.1数组角标异常：

![image-20200928140658510](images/jvm_memory.assets/image-20200928140658510.png)

因为在堆内存中根本就没有分配第七个空间了

![image-20200928140705656](images/jvm_memory.assets/image-20200928140705656.png)

#### 3.4.2数组的空指针异常：

![image-20200928140712499](images/jvm_memory.assets/image-20200928140712499.png)

因为原本执行堆内存空间的地址被null给赋值了
如下图所示：

![image-20200928140718813](images/jvm_memory.assets/image-20200928140718813.png)

![image-20200928140728311](images/jvm_memory.assets/image-20200928140728311.png)
...
![image-20200928140924289](images/jvm_memory.assets/image-20200928140924289.png)
...
![image-20200928141326230](images/jvm_memory.assets/image-20200928141326230.png)
...
![image-20200928141404698](images/jvm_memory.assets/image-20200928141404698.png)
...
![image-20200928141431291](images/jvm_memory.assets/image-20200928141431291.png)

内存分析：

![image-20200928141437277](images/jvm_memory.assets/image-20200928141437277.png)
