# 🚀 Docker + Docsify + Jenkins 搭建 CI/CD 的步骤（Gitee 版本）

> 💡 由于国内访问 GitHub 太慢了，导致 Webhook 也经常超时，经常触发不了，所以改成了 Gitee，速度超快

> ⚠️ **注意**: 前面的准备都是一样的，主要是 Jenkins 和 Gitee 的配置
...
#### 🔗 4.4.2 Jenkins 安装 Gitee

📖 **官方文档**: [Gitee Jenkins 插件配置指南](https://gitee.com/help/articles/4193#article-header3)

##### 🌐 4.4.2.1 Webhook 配置地址
